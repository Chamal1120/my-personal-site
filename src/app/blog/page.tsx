...
const BlogPage = () => {
  ...
  return (
    <section>
      <h2 className="font-bold py-36 text-3xl">Things I&apos;ve written.</h2>
      ...
      {posts.length > 0 ? (
        ...
        <div role="status" className="flex item-center justify-center min-h-screen">
          <svg aria-hidden="true" className="w-8 h-8 text-ctp-crust-dark animate-spin dark:text-ctp-crust-dark fill-ctp-crust-light" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
