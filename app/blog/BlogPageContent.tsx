...
export default function BlogPageContent() {
  ...
  return (
    <section className="grow px-8 pt-4">
      {/*<div className="hidden w-full grow flex-wrap">
      ...
      <div className="flex w-full grow flex-wrap">
        ...
        {externalPosts.length > 0 ? (
          ...
          <div
            role="status"
            className="item-center flex min-h-screen w-full grow justify-center"
          >
            <svg
              aria-hidden="true"
              className="fill-ctp-crust-light text-ctp-crust h-8 w-8 animate-spin"
              viewBox="0 0 100 101"
              fill="none"
